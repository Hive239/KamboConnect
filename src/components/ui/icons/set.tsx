...
export const CalendarDays = makeIcon((w) => <><Duo d="M5 6h14a1 1 0 011 1v12a1 1 0 01-1 1H5a1 1 0 01-1-1V7a1 1 0 011-1Z" weight={w} opacity={0.12} /><rect x="4" y="6" width="16" height="14" rx="2" /><path d="M4 10h16M8 3.5v4M16 3.5v4" /><circle cx="8.5" cy="14" r="0.7" fill="currentColor" stroke="none" /><circle cx="12" cy="14" r="0.7" fill="currentColor" stroke="none" /><circle cx="15.5" cy="14" r="0.7" fill="currentColor" stroke="none" /><circle cx="8.5" cy="17" r="0.7" fill="currentColor" stroke="none" /><circle cx="12" cy="17" r="0.7" fill="currentColor" stroke="none" /></>, "CalendarDays");
export const TrendingUp = makeIcon((w) => <><Duo d="M4 15l5-5 4 3 7-8V19H4Z" weight={w} opacity={0.12} /><path d="M4 15l5-5 4 3 7-8" /><path d="M15.5 5h4.5v4.5" /></>, "TrendingUp");
export const Storefront = makeIcon((w) => <><Duo d="M5 11h14v8a1 1 0 01-1 1H6a1 1 0 01-1-1v-8Z" weight={w} opacity={0.12} /><path d="M5 11.5V19a1 1 0 001 1h12a1 1 0 001-1v-7.5" /><path d="M3.5 7.6L5 4h14l1.5 3.6a2.35 2.35 0 01-4.25 1.55 2.35 2.35 0 01-4.25 0 2.35 2.35 0 01-4.25 0A2.35 2.35 0 013.5 7.6Z" /><path d="M9.5 20v-3.5a1 1 0 011-1h3a1 1 0 011 1V20" /></>, "Storefront");
