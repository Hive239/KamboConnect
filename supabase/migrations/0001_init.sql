...
create policy "profiles_rw" on public.profiles for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "practitioners_write" on public.practitioners for all using (true) with check (true);
...
create policy "reviews_write" on public.reviews for all using (true) with check (true);
...
create policy "event_registrations_rw" on public.event_registrations for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "posts_write" on public.posts for all using (true) with check (true);
...
create policy "replies_write" on public.replies for all using (true) with check (true);
...
create policy "community_resources_write" on public.community_resources for all using (true) with check (true);
...
create policy "bookings_rw" on public.bookings for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "messages_rw" on public.messages for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "practitioner_availability_write" on public.practitioner_availability for all using (true) with check (true);
...
create policy "payments_rw" on public.payments for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "conversations_rw" on public.conversations for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "notifications_rw" on public.notifications for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "favorites_rw" on public.favorites for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "practitioner_blocked_dates_write" on public.practitioner_blocked_dates for all using (true) with check (true);
...
create policy "practitioner_exceptions_write" on public.practitioner_exceptions for all using (true) with check (true);
...
create policy "reports_rw" on public.reports for all using (true) with check (true); -- TODO tighten (admin)
...
create policy "saved_searches_rw" on public.saved_searches for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "follows_rw" on public.follows for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "groups_write" on public.groups for all using (true) with check (true);
...
create policy "group_memberships_rw" on public.group_memberships for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "feed_items_write" on public.feed_items for all using (true) with check (true);
...
create policy "orders_rw" on public.orders for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "subscriptions_rw" on public.subscriptions for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "credentials_write" on public.credentials for all using (true) with check (true);
...
create policy "screening_responses_rw" on public.screening_responses for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "consent_records_rw" on public.consent_records for all using (true) with check (true); -- TODO tighten (owner)
...
create policy "moderation_cases_rw" on public.moderation_cases for all using (true) with check (true); -- TODO tighten (admin)
